"""
JNJ 물타기 전략 대시보드
streamlit run dashboard_jnj.py --server.port 8507

고빈도 전략: RSI 45/50 → 60/55, GC OFF
- 거래 30회, 물타기 최대 7회, 승률 100%, 수익률 +4.2%
- 헬스케어 섹터 (제약/의료기기)
"""
...
def main():
    ...
    st.caption(f"헬스케어 섹터 (제약/의료기기) | 마지막 업데이트: {datetime.now().strftime('%Y-%m-%d %H:%M')}")
